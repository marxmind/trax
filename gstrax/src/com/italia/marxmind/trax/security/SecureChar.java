...
public class SecureChar {
	...
	public static String encode(String val){
		...
		try{
		// encode with padding
		String encoded = Base64.getEncoder().encodeToString(val.getBytes(Gstrax.SECURITY_ENCRYPTION_FORMAT.getName()));
	...
	public static String decode(String val){
		try{
			...
			return new String(barr,Gstrax.SECURITY_ENCRYPTION_FORMAT.getName());
			}catch(Exception e){}
			return null;
	}
